...
library(swaRmverse)
scores <- read.csv('../Data/metrics_pigeons.csv')
...
X <- ggplot2::ggplot(scores, ggplot2::aes(x = PC1, y = PC2, fill = species,
  ...
  ggplot2::theme(legend.position = 'top',
                 ...
                 plot.title = ggplot2::element_text( size = 28, family = 'Palatino Linotype', hjust = 0.5),
                 axis.title =  ggplot2::element_text(color = 'black', size = 28, family = 'Palatino Linotype'),
                 axis.text =   ggplot2::element_blank(),
                 legend.title = ggplot2::element_text( size = 28, family = 'Palatino Linotype'),
                 legend.text = ggplot2::element_text( size = 28, family = 'Palatino Linotype') )+
